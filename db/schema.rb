...
ActiveRecord::Schema.define(:version => 20130725235626) do
  ...
  add_index "assigned_things", ["thing_id"], :name => "index_assigned_things_on_thing_id"
  add_index "assigned_things", ["user_id"], :name => "index_assigned_things_on_user_id"
